  ...
  return (
    <div className="Elements">
        <ul>
            ...
            <li><img src="https://moviesshopco.vtexassets.com/assets/vtex/assets-builder/moviesshopco.theme3/3.0.40/shopping___eba0ed4ccfbadce9d287241eabeed60f.svg" alt=""/></li>
        </ul>
    </div>
  )
}
